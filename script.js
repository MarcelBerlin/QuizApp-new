...
function answer(selection) { // Die Variable "selection" wurde bereits im HTML Code (index.html) für jede Frage einzeln definiert. Bsp: answer_1; answer_2 usw. 
    let question = questions[currentquestion];  // Die Variable "question" bezieht sich nun auf unser Array "questions" an "0"ter Stelle. Durch "currentquestion" haben wir das bereits global definiert.
